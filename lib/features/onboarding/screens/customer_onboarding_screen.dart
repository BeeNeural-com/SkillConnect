...
class _CustomerOnboardingScreenState extends State<CustomerOnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = [
    OnboardingPage(
      ...
      description:
          'Browse through verified technicians in your area for all your home service needs',
    ...
    OnboardingPage(
      ...
      description:
          'Schedule appointments at your convenience and get instant confirmations',
      gradient: LinearGradient(
    ...
    OnboardingPage(
      ...
      title: 'Rate & Review',
      description:
          'Share your experience and help others find the best technicians',
      gradient: LinearGradient(
    ...
    OnboardingPage(
      ...
      description:
          'Monitor service progress in real-time and communicate directly with technicians',
      gradient: LinearGradient(
